...
namespace AddressBook {
    public partial class Form1 : Form {
        ...
        {
            // TODO: このコード行はデータを 'infosys202120DataSet.Person' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            this.personTableAdapter.Fill(infosys202120DataSet.Person);
        }

        private void tbNameFilter_Click(object sender, EventArgs e)
        {
            this.personTableAdapter.FillByName(this.infosys202120DataSet.Person,tbNameSearch.Text);
        }
        ...
        {
            this.personTableAdapter.FillByBirthDay(this.infosys202120DataSet.Person, dtpBirthdaySearch.Text);
        }
    }
}
